...
function openCase(caseId) {
  ...
  modalBody.innerHTML = `<div class="section"><div class="section-title">案例摘要</div><div class="section-body">${esc(c.案例摘要)}</div></div><div class="section"><div class="section-title">問題內容</div><div class="section-body">${esc(c.問題內容)}</div></div>${rxBlock(c)}<div class="section"><div class="section-title">原始全文</div><div class="section-body"><div class="prebox">${esc(c.原始全文)}</div></div></div>${tagBlock(c, keyword)}<div class="section"><div class="section-title">資料來源</div><div class="section-body">${esc(c.資料來源)}</div></div>`;
